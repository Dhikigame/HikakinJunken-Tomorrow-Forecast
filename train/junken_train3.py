...
dr_junken = dr_junken_all[[0,1,2,3,4]]
dr_junken.columns = [u'result', u'month', u'nth_week', u'before_result_1', u'before_result_2']
...
X = dr_junken[['month', 'nth_week', 'before_result_1', 'before_result_2']]
...
for junkencount in range(150, len(z)):
    ...
    test_data = [[month, nth_week, before_result_1, before_result_2]]
    # print(test_data)
